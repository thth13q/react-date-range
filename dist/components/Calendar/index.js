  ...
  function Calendar(_props, context) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderMonthAndYear", function (focusedDate, changeShownDate, props) {
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        className: styles.monthAndYearPickers
      }, _this.state.monthNames[focusedDate.getMonth()], " ", focusedDate.getFullYear()), /*#__PURE__*/_react.default.createElement("span", {
        className: styles.monthAndYearPickers
      }, _this.state.monthNames[(0, _addMonths.default)(focusedDate, 1).getMonth()], " ", (0, _addMonths.default)(focusedDate, 1).getFullYear())), showMonthArrow ? /*#__PURE__*/_react.default.createElement("button", {
        type: "button",
